...
public:
	...
	void					TouchMoved(Touch* touch); //Correct?
	void					TouchEnded(Touch* touch); //?
	void					TouchesCanceled(); //?
	Widget*					GetGamepadSelection();
	void					SetGamepadSelection(Widget *theSelectedWidget, int theDirection); //?
#ifdef _SEXYDECOMP_USE_LATEST_CODE
	void					GamepadButtonDown(GamepadButton theButton, int thePlayer, GamepadButtonExta theFlags);
	void					GamepadButtonUp(GamepadButton theButton, int thePlayer, GamepadButtonExta theFlags);
	void					GamepadAxisMove(GamepadAxis theAxis, int thePlayer, float theAxisValue);
#else
	void					GamepadButtonDown(int theButton, int thePlayer, ulong theFlags);
	void					GamepadButtonUp(int theButton, int thePlayer, ulong theFlags);
	void					GamepadAxisMove(int theAxis, int thePlayer, int theAxisValue);
#endif
	IGamepad*				GetGamepadForPlayer(int thePlayer); //?
};
