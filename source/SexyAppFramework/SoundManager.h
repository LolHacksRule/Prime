...
#define MAX_SOURCE_SOUNDS	4096 //now 4096 why idk
...
public:
	...
	virtual void			SetVolume(int theVolIdx, double theVolume) = 0;
	...
	virtual void			SetCooperativeWindow(HWND theHWnd, bool isWindowed) = 0; //Only appears in nonBass
