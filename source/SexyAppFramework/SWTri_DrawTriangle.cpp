...
void	Sexy::funcname(SWHelper::SWVertex * pVerts, void * pFrameBuffer, const unsigned int bytepitch, const SWHelper::SWTextureInfo * textureInfo, SWHelper::SWDiffuse & globalDiffuse) //TODO
{
	uchar* aMaxTable; //?
	int* aMaxTableRB = gSexyAppBase->mGraphicsDriver->GetNativeDisplayInfo()->mRedAddTable;
	int* aMaxTableG = gSexyAppBase->mGraphicsDriver->GetNativeDisplayInfo()->mGreenAddTable;
