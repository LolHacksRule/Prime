...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static int FixedFloor(int x) //27-32
{
	if (x>0)
		return x&0xFFFF0000;
	else
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static inline void lClip(SWHelper::XYZStruct & dst, const SWHelper::XYZStruct & on, const SWHelper::XYZStruct & off, const float edge) //50-60
{
...
static inline void rClip(SWHelper::XYZStruct & dst, const SWHelper::XYZStruct & on, const SWHelper::XYZStruct & off, const float edge) //65-75
{
   float	delta = (edge - off.mX) / (on.mX - off.mX);
   dst.mX = off.mX + (on.mX - off.mX) * delta;
   dst.mY = off.mY + (on.mY - off.mY) * delta;
...
static inline void tClip(SWHelper::XYZStruct & dst, const SWHelper::XYZStruct & on, const SWHelper::XYZStruct & off, const float edge) //80-90
{
...
static inline void bClip(SWHelper::XYZStruct & dst, const SWHelper::XYZStruct & on, const SWHelper::XYZStruct & off, const float edge) //95-100
{
   float	delta = (edge - off.mY) / (on.mY - off.mY);
   dst.mX = off.mX + (on.mX - off.mX) * delta;
   dst.mY = off.mY + (on.mY - off.mY) * delta;
...
static inline unsigned int leClip(SWHelper::XYZStruct ** src, SWHelper::XYZStruct ** dst, const float edge) //110-146
{
...
static inline unsigned int reClip(SWHelper::XYZStruct ** src, SWHelper::XYZStruct ** dst, const float edge) //151-187
{
   SWHelper::XYZStruct ** _dst = dst;
...
static inline unsigned int teClip(SWHelper::XYZStruct ** src, SWHelper::XYZStruct ** dst, const float edge) //192-228
{
   SWHelper::XYZStruct ** _dst = dst;
...
static inline unsigned int beClip(SWHelper::XYZStruct ** src, SWHelper::XYZStruct ** dst, const float edge) //233-269
{
   SWHelper::XYZStruct ** _dst = dst;
...
static inline int	clipShape(SWHelper::XYZStruct ** dst, SWHelper::XYZStruct ** src, const float left, const float right, const float top, const float bottom) //274-287
{
...
void SWHelper::SWDrawShape(XYZStruct *theVerts, int theNumVerts, MemoryImage *theImage, const Color &theColor, int theDrawMode, const Rect &theClipRect, void *theSurface, int thePitch, int thePixelFormat, bool blend, bool vertexColor) //306-498
{
...
//				unsigned int	temp = static_cast<unsigned int>(mSWTexture->mTextureInfo.lPitch) / (mSWTexture->mTextureInfo.ddpfPixelFormat.dwRGBBitCount / 8);
			...
			SWDrawTriangle(textured, talpha, vertexColor, globalargb, pVerts, pFrameBuffer, thePitch, &textureInfo, globalDiffuse, thePixelFormat, blend, theDrawMode == Graphics::DRAWMODE_ADDITIVE);
...
static DrawTriFunc gDrawTriFunc[256] = {0};
void Sexy::SWTri_AddDrawTriFunc(bool textured, bool talpha, bool mod_argb, bool global_argb, int thePixelFormat, bool blend, DrawTriFunc theFunc) //503-513
{
...
void Sexy::SWTri_AddAllDrawTriFuncs() //516-774
{
	...
	gDrawTriFunc[127] = DrawTriangle_0555_TEX1_TALPHA1_MOD1_GLOB1_BLEND1; //Nore after
	gDrawTriFunc[128] = DrawTriangle_8888_TEX0_TALPHA0_MOD0_GLOB0_BLEND0_ADDITIVE;
	gDrawTriFunc
MOD0_GLOB0_BLEND1_ADDITIVE;
	gDrawTriFunc[226] = DrawTriangle_0555_TEX0_TALPHA0_MOD0_GLOB1_BLEND0_ADDITIVE;
	gDrawTriFunc[227] = DrawTriangle_0555_TEX0_TALPHA0_MOD0_GLOB1_BLEND1_ADDITIVE;
	gDrawTriFunc[228] = DrawTriangle_0555_TEX0_TALPHA0_MOD1_GLOB0_BLEND0_ADDITIVE;
	gDrawTriFunc[229] = DrawTriangle_0555_TEX0_TALPHA0_MOD1_GLOB0_BLEND1_ADDITIVE;
	gDrawTriFunc[230] = DrawTriangle_0555_TEX0_TALPHA0_MOD1_GLOB1_BLEND0_ADDITIVE;
	gDrawTriFunc[231] = DrawTriangle_0555_TEX0_TALPHA0_MOD1_GLOB1_BLEND1_ADDITIVE;
	gDrawTriFunc[232] = DrawTriangle_0555_TEX0_TALPHA1_MOD0_GLOB0_BLEND0_ADDITIVE;
	gDrawTriFunc[233] = DrawTriangle_0555_TEX0_TALPHA1_MOD0_GLOB0_BLEND1_ADDITIVE;
	gDrawTriFunc[234] = DrawTriangle_0555_TEX0_TALPHA1_MOD0_GLOB1_BLEND0_ADDITIVE;
	gDrawTriFunc[235] = DrawTriangle_0555_TEX0_TALPHA1_MOD0_GLOB1_BLEND1_ADDITIVE;
	gDrawTriFunc[236] = DrawTriangle_0555_TEX0_TALPHA1_MOD1_GLOB0_BLEND0_ADDITIVE;
	gDrawTriFunc[237] = DrawTriangle_0555_TEX0_TALPHA1_MOD1_GLOB0_BLEND1_ADDITIVE;
	gDrawTriFunc[238] = DrawTriangle_0555_TEX0_TALPHA1_MOD1_GLOB1_BLEND0_ADDITIVE;
	gDrawTriFunc[239] = DrawTriangle_0555_TEX0_TALPHA1_MOD1_GLOB1_BLEND1_ADDITIVE;
	gDrawTriFunc[240] = DrawTriangle_0555_TEX1_TALPHA0_MOD0_GLOB0_BLEND0_ADDITIVE;
	gDrawTriFunc[241] = DrawTriangle_0555_TEX1_TALPHA0_MOD0_GLOB0_BLEND1_ADDITIVE;
	gDrawTriFunc[242] = DrawTriangle_0555_TEX1_TALPHA0_MOD0_GLOB1_BLEND0_ADDITIVE;
	gDrawTriFunc[243] = DrawTriangle_0555_TEX1_TALPHA0_MOD0_GLOB1_BLEND1_ADDITIVE;
	gDrawTriFunc[244] = DrawTriangle_0555_TEX1_TALPHA0_MOD1_GLOB0_BLEND0_ADDITIVE;
	gDrawTriFunc[245] = DrawTriangle_0555_TEX1_TALPHA0_MOD1_GLOB0_BLEND1_ADDITIVE;
	gDrawTriFunc[246] = DrawTriangle_0555_TEX1_TALPHA0_MOD1_GLOB1_BLEND0_ADDITIVE;
	gDrawTriFunc[247] = DrawTriangle_0555_TEX1_TALPHA0_MOD1_GLOB1_BLEND1_ADDITIVE;
	gDrawTriFunc[248] = DrawTriangle_0555_TEX1_TALPHA1_MOD0_GLOB0_BLEND0_ADDITIVE;
	gDrawTriFunc[249] = DrawTriangle_0555_TEX1_TALPHA1_MOD0_GLOB0_BLEND1_ADDITIVE;
	gDrawTriFunc[250] = DrawTriangle_0555_TEX1_TALPHA1_MOD0_GLOB1_BLEND0_ADDITIVE;
	gDrawTriFunc[251] = DrawTriangle_0555_TEX1_TALPHA1_MOD0_GLOB1_BLEND1_ADDITIVE;
	gDrawTriFunc[252] = DrawTriangle_0555_TEX1_TALPHA1_MOD1_GLOB0_BLEND0_ADDITIVE;
	gDrawTriFunc[253] = DrawTriangle_0555_TEX1_TALPHA1_MOD1_GLOB0_BLEND1_ADDITIVE;
	gDrawTriFunc[254] = DrawTriangle_0555_TEX1_TALPHA1_MOD1_GLOB1_BLEND0_ADDITIVE;
	gDrawTriFunc[255] = DrawTriangle_0555_TEX1_TALPHA1_MOD1_GLOB1_BLEND1_ADDITIVE;	
}

#include "SWTri_DrawTriangleInc1.cpp"

void	SWHelper::SWDrawTriangle(bool textured, bool talpha, bool mod_argb, bool global_argb, SWVertex * pVerts, unsigned int * pFrameBuffer, const unsigned int bytepitch, const SWTextureInfo * textureInfo, SWDiffuse & globalDiffuse, int thePixelFormat, bool blend, bool additive) //add additive
{
	int aType = (additive?128:0) | (blend?1:0) | (global_argb?2:0) | (mod_argb?4:0) | (talpha?8:0) | (textured?16:0);
	switch (thePixelFormat)
	{
		case 0x8888: aType |= 0<<5; break;
		case 0x888: aType |= 1<<5; break;
	...
	if (aFunc==NULL)
	{
		DBG_ASSERT("You need to call SWTri_AddDrawTriFunc or SWTri_AddAllDrawTriFuncs"==NULL); //791
	}
	else
